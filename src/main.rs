...
fn main() {
    ...
    let mut font = ttf_context
        .load_font("assets/lucida.ttf", 64)
        .expect("Dould't load the font");
...
fn display_game_information<'a>(
    ...
    canvas
        .copy(
            &lines_sent,
            None,
            get_rect_from_text(&lines_sent_text, start_x_point, 160),
        )
        .expect("Could't copy text");
    canvas
        .copy(
            &level,
            None,
